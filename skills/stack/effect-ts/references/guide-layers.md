...
This is also the correct constructor for services that own resources with acquisition and release semantics. In Effect v4, `Layer.effect` replaces the old `Layer.scoped` API.
