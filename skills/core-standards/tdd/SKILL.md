---
name: tdd
description: Red-green-refactor development. Use when implementing behavior test-first, fixing a bug with a failing reproduction, adding integration or property tests, or when a worker/spec asks for a TDD slice plan.
---
...
- Prefer recording fakes supplied through production seams over mocks, even at
  system boundaries.
- Use risk-matched evidence and the repository's canonical test command as
