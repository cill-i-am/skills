---
name: tech-spec
description: Typed call-stack architecture handoff. Use when turning a PRD, architecture candidate, issue, design conversation, or codebase investigation into an implementation-ready TypeScript spec with contracts, seams, data flow, and RGR test slices.
---
